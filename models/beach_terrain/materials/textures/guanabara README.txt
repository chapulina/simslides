...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=guanabara&box=-42.947689,-22.677144,-43.308795,-23.009520
...
-----------
  ...
  * guanabara Height Map (ASTER 30m).png
  ...
  * guanabara Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * guanabara Height Map (SRTM3 v4.1).png
  ...
  * guanabara Height Map (SRTM30 Plus).png
