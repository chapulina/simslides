...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=zonasul&box=-43.144826,-22.925145,-43.222895,-22.997010
...
-----------
  ...
  * zonasul Height Map (ASTER 30m).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * zonasul Height Map (SRTM3 v4.1).png
  ...
  * zonasul Height Map (SRTM30 Plus).png
